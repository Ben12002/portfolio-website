    ...
    return(
        <div id="resumeheading" className="resumesection">
            ...
            <div className="content">
                <a href="public/Benedict Tan Coop Resume.png" download="Benedict_Tan_Resume.pdf" className="download-button">
                ...
                <img src="public/Benedict Tan Coop Resume.png" width='400px' alt="Benedict Tan Resume" className="resume-preview"></img>
            </div>
        </div>
    )
}
